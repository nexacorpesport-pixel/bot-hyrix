...
module.exports = async (client, member) => {
    ...
    const channel = await member.guild.channels.create({
        name: `setup-${member.user.username}`,
    ...
    client.on("interactionCreate", async (interaction) => {
        ...
        if (interaction.customId === "homme") {
            ...
            await member.roles.add([ROLE_HOMME, ROLE_GENERAL]);
        ...
        if (interaction.customId === "femme") {
            ...
            await member.roles.add([ROLE_FEMME, ROLE_GENERAL]);
        ...
        if (interaction.customId === "nop") {
            ...
            await member.roles.add([ROLE_NOP, ROLE_GENERAL]);
