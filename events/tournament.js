...
// Les deux IDs de rôles à donner aux membres
...
client.on('ready', async () => {
    ...
    try {
        ...
        // On récupère les 50 derniers messages du salon pour voir si le règlement existe déjà
        ...
        // Si aucun message du bot n'est trouvé, on génère le règlement complet
        ...
        // Envoi des 3 embeds d'un coup dans le même message pour éviter le découpage
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.customId === 'accept_rules_aeroz') {
        ...
        // On vérifie si le membre possède déjà AU MOINS UN des rôles requis
        ...
        try {
            // Attribution automatique des deux rôles d'un coup
